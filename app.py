...
SCHEDULE_TEMPLATES = {
    "График1": [12, 12, 0, 0],        # 2 рабочих дня по 12 часов, 2 выходных
    "График2": [12, 12, 12, 0, 0, 0], # 3 рабочих дня по 12 часов, 3 выходных
    "Офисный": [8]*5 + [0]*2          # 5 дней по 8 часов, 2 выходных
}
...
def create_schedule():
    employees = [
        ...
        EmployeeSchedule("Иванов И.И.", "ГР2", "График2", {'5': '8'}),
        EmployeeSchedule("Петров П.П.", "офис", "Офисный", {'10': 'отпуск'}),
